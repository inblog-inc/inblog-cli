...
export function registerBlogsCommands(program: Command): void {
  ...
  blogs
    ...
    .option('--logo <url>', 'Blog logo image URL')
    .option('--favicon <url>', 'Blog favicon image URL')
    .option('--og-image <url>', 'Blog OG image URL')
    ...
    .action(async function (this: Command) {
      ...
      try {
        ...
        // Need subdomain for the update endpoint
  ...
  banner
    ...
    .option('--image <url>', 'Banner image URL')
